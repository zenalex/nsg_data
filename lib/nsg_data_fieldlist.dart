...
class NsgFieldValues {
  ...
  ///Читаем СВОЮ сериализацию, а не ответ сервера.
  ///
  ///Влияет ровно на одно: строки табличной части сохраняют прочитанный из json
  ///`docState` вместо принудительного `saved`. Включается только через
  ///[NsgDataItem.restoreFromJson] — там же и объяснение, почему этого нельзя
  ///делать всегда.
  bool keepRowDocState = false;
